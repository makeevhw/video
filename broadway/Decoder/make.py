...
#sys.path.append("/home/avallon/Documents/SPBAU/1sem/NIR/sandbox/broadway/emscripten-1.35.12")
...
emcc_args = [
  ...
  #,  '-s', '''BINARYEN=\"/home/avallon/Documents/SPBAU/1sem/NIR/sandbox/binaryen-version_19\"'''
  ,'-s', 'BINARYEN=1'
  #, '-s', 'ASSERTIONS=1'
]
